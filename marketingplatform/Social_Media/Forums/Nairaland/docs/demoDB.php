...
$servername = "nex-mariadb-01.nexius.com";
$username = "root";
$password = "Nexius20171";
$dbname = "test";
...
INTO
    test_nairalandforum
    (
        Poster, DATE, PostID, SearchKeyword, Topic, Board, PostMsg, likes, shares
    )
    VALUES ('$poster', '$date', '$id', '$searchKeyword', '$topic', '$board', '$post', '$likes', '$shares')";
