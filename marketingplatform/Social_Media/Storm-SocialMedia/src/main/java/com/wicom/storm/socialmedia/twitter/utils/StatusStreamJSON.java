...
public class StatusStreamJSON extends JSONObject {
    ...
    public StatusStreamJSON(Status twitterStatus) throws JSONException {
        super(JSONStringHelper.replaceNewlineChar(TwitterObjectFactory.getRawJSON(twitterStatus)));
    ...
    public void setMatchedKeywordsTag (String[] keywords) throws JSONException {
