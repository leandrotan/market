...
public class EricssonGsmXMLParser implements Function {
    static Logger LOGGER = LoggerFactory.getLogger(EricssonGsmXMLParser.class);
    ...
    public void execute(TridentTuple tridentTuple, TridentCollector tridentCollector) {
        ...
        String genericHeader = date_sid + "|" + date_id+ "|" +hour_sid+ "|" +second_sid;
